<div class="navbar navbar-fixed-top">
    <div class="navbar-inner2">
        <div class="name">
            ...
            <div class="btn-group">
                <button class="btn"><i class="icon-cog icon-large"></i>&nbsp;Account</button>
            ...
            <div class="pull-right"> <a href="user_cart.php" class="btn btn-info"><i class="icon-shopping-cart icon-large"></i>&nbsp;My Cart
                    <?php
                    $count_query = mysql_query("select * from order_details where memberID='$ses_id' and status=''") or die(mysql_error());
